    ...
    <ScrollView>
      ...
      <View>
        <Image
          ...
          source={require("../assets/images/WhatsApp Image 2024-04-13 at 9.04.52 PM.jpeg")}
        />
        <Pressable
          onPress={() => {
            setShowModal(true);
        ...
        >
          <Image
            style={{ width: 400, height: 500, borderRadius: 10, marginTop: 10 }}
            source={require("../assets/images/WhatsApp Image 2024-04-13 at 9.04.51 PM.jpeg")}
          />
        </Pressable>
        <Pressable
          onPress={() => {
        ...
        >
          <Image
            style={{ width: 400, height: 500, borderRadius: 10, marginTop: 10 }}
            source={require("../assets/images/WhatsApp Image 2024-04-13 at 9.04.51 PM (2).jpeg")}
          />
        </Pressable>
      </View>
    </ScrollView>
